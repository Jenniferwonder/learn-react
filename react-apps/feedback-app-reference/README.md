...
> Code changes can be seen in [FeedbackContext.js](FeedbackContext.js#L62)
...
> Code changes can be seen in [FeedbackContext.js](FeedbackContext.js#L65)
...
Code changes can be seen in [FeedbackForm.jsx](FeedbackForm.jsx#L24)

#### Q: How do you reset state after submitting a feedback?

Reset sate back to default after adding a new feedback.

> Code changes can be seen in [FeedbackForm.jsx](FeedbackForm.jsx#L57)
...
just a duplicate of parent state. Relies on `selected` being passed as prop in [FeedbackForm.jsx](FeedbackForm.jsx#L64)

Additionally here we can simplify our JSX with iteration.

> Code changes can be seen in [RatingSelect.jsx](RatingSelect.jsx#L2) and [FeedbackForm.jsx](FeedbackForm.jsx#L64)
...
> Code changes can be see in [index.css](index.css#L188)
